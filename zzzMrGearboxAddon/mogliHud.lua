...
--=======================================================================================
	local function newClass( _globalClassName_, _level0_ )
		...
		-- init
		------------------------------------------------------------------------
		function _newClass_:init( directory, hudName, hudBackground, onTextID, offTextID, showHudKey, x, y, nx, ny, height, text, cbOnClick, width, border )
			self[_level0_] = {}
		...
		-- draw
		------------------------------------------------------------------------
		function _newClass_:draw(hideKey)
			if self.isClient and self[_level0_] ~= nil then
				if self[_level0_].GuiActive then
					...
					renderText(self[_level0_].TextPosX, self[_level0_].TitlePosY, self[_level0_].TextSize ,self[_level0_].Title);		
				...
				elseif hideKey == nil or not hideKey then
					g_currentMission:addHelpButtonText(_newClass_.getText(self[_level0_].GuiOnTextID), self[_level0_].GuiShowKey);
				end
			end
		end
